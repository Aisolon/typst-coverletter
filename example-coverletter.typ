...
#show: coverletter.with(
  ...
  recipient: (
    ...
    cl-title: [Job Application for the role of Data Scientist],
    date: [],
    department: none,// [Department of Example],
    institution: [Norwegian Refugee Council],
    address: none,// [London, UK],
    postcode: none,//[W1 S2],
  ),
...
I'm excited to be applying for the position as a data scientist helping build and implement CLEAR. 
// #lorem(400)
